...
const headlessBase64 = (
  ...
  bot.on("startepisode", (episodeNum) => {
    if (ended) {
      ...
      ended = false;
      endRecording = false;
      actionFlags.attack = false;
      actionFlags.use = false;
      actionFlags.mount = false;
      actionFlags.dismount = false;
      actionFlags.place_block = false;
      actionFlags.place_entity = false;
      // Don't reset mine
      actionFlags["hotbar.1"] = false;
      actionFlags["hotbar.2"] = false;
      actionFlags["hotbar.3"] = false;
      actionFlags["hotbar.4"] = false;
      actionFlags["hotbar.5"] = false;
      actionFlags["hotbar.6"] = false;
      actionFlags["hotbar.7"] = false;
      actionFlags["hotbar.8"] = false;
      actionFlags["hotbar.9"] = false;
